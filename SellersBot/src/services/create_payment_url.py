...
from ..core import PAYMENT_PROVIDER_TERMINAL, PAYMENT_PROVIDER_USERNAME, DEFAULT_LOCALE, bot, B2B_GROUP_ID, BACKEND_URL
...
async def create_payment_url(session: AsyncSession, author_full_name: str, author_user_id: int,
    ...
    return response_url, token_instance.value
